                    ...
                    <div class="hero-inner">
                        ...
                        <div class="hero-form newsletter-form field field-grouped is-revealing">
                            <div class="control control-expanded">
                                <input class="input" type="text" name="text" placeholder="suggust your best idea &hellip;">
                            </div>
                            <div class="control">
                                <a class="button button-primary button-block button-shadow" href="#">suggust</a>
                            </div>
                        </div>
