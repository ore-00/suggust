            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Which game would you recommend developing for the Indian audience?</h1>
                        <p class="hero-paragraph is-revealing">"Considering the Indian gaming market, I'm seeking suggestions on which type of game would resonate best with the audience here. Your insights would really help in making a well-informed decision. What do you think?"</p>

                        <form method="post">
                        <div class="hero-form newsletter-form field field-grouped is-revealing">
                            <div class="control control-expanded">
                                <input class="input" type="text" name="sug" id="sug" placeholder="suggest your best idea &hellip;">
                            </div>
                        

                            <div class="control">
                                <button class="button button-primary button-block button-shadow" value="suggest" name="suggest" id="suggest">suggest</button>
                            </div>
...
$data=$con->query("INSERT INTO `data_table`(`sug`) VALUES ('$sug')");
   ...
   echo "<script>alert('please enter vaild Suggestion');</script>";
 }
